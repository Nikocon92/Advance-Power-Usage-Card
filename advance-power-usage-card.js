...
var BAR_UNFILLED_COLOR = "rgba(26,54,85,0.35)";
        ...
        <div class="wrap">
          ...
          <div class="right-panel">
            <div class="summary-bar-wrap">
              ${barStyle === "scale" ? `<div class="bar bar-scale" style="background: linear-gradient(90deg, ${colorAtRatio(stops, totalRatio)} ${(totalRatio * 100).toFixed(2)}%, ${BAR_UNFILLED_COLOR} ${(totalRatio * 100).toFixed(2)}%);"></div>` : `<div class="bar"></div><div class="arrow" style="left: calc(${(totalRatio * 100).toFixed(2)}% - var(--arrow-half))"></div>`}
            </div>
